...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((bounding_boxes
    ...
    :type (cl:vector cv_package-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'cv_package-msg:BoundingBox :initial-element (cl:make-instance 'cv_package-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_package-msg:<BoundingBoxes> is deprecated: use cv_package-msg:BoundingBoxes instead.")))

(cl:ensure-generic-function 'bounding_boxes-val :lambda-list '(m))
(cl:defmethod bounding_boxes-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_package-msg:bounding_boxes-val is deprecated.  Use cv_package-msg:bounding_boxes instead.")
  (bounding_boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cv_package-msg:BoundingBox))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBoxes>)))
  ...
  (cl:format cl:nil "BoundingBox[] bounding_boxes~%~%================================================================================~%MSG: cv_package/BoundingBox~%string object_label~%float64 probability~%int64 xmin_cv~%int64 ymin_cv~%int64 xmax_cv~%int64 ymax_cv~%float64 xcenter_cv~%float64 ycenter_cv~%int64 width~%int64 height~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBoxes)))
  "Returns full string definition for message of type 'BoundingBoxes"
  (cl:format cl:nil "BoundingBox[] bounding_boxes~%~%================================================================================~%MSG: cv_package/BoundingBox~%string object_label~%float64 probability~%int64 xmin_cv~%int64 ymin_cv~%int64 xmax_cv~%int64 ymax_cv~%float64 xcenter_cv~%float64 ycenter_cv~%int64 width~%int64 height~%~%~%"))
