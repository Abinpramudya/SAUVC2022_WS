...
"""autogenerated by genpy from cv_package/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['cv_package/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cv_package.msg.BoundingBox()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
