// Generated by gencpp from file cv_package/kamera.msg
// DO NOT EDIT!


#ifndef CV_PACKAGE_MESSAGE_KAMERA_H
#define CV_PACKAGE_MESSAGE_KAMERA_H
...
struct kamera_
{
  ...
  typedef boost::shared_ptr< ::cv_package::kamera_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cv_package::kamera_<ContainerAllocator> const> ConstPtr;

}; // struct kamera_

typedef ::cv_package::kamera_<std::allocator<void> > kamera;

typedef boost::shared_ptr< ::cv_package::kamera > kameraPtr;
typedef boost::shared_ptr< ::cv_package::kamera const> kameraConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cv_package::kamera_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cv_package::kamera_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cv_package::kamera_<ContainerAllocator1> & lhs, const ::cv_package::kamera_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::cv_package::kamera_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cv_package::kamera_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cv_package::kamera_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cv_package::kamera_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cv_package::kamera_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cv_package::kamera_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cv_package::kamera_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cv_package::kamera_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x16489477eaaf0dbcULL;
  static const uint64_t static_value2 = 0xa582174d9a0d8936ULL;
};

template<class ContainerAllocator>
struct DataType< ::cv_package::kamera_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cv_package::kamera_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cv_package::kamera_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cv_package::kamera_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cv_package::kamera_<ContainerAllocator>& v)
  {
...
#endif // CV_PACKAGE_MESSAGE_KAMERA_H
